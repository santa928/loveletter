...
> = {
  "how-to": {
    title: "遊び方",
    lead: "2〜4人で1台の端末を順に渡し、最後まで密書を守る人を探ります。",
    items: [
      "自分の番だけ端末を見て、密書を一枚引きます。",
      "二通のうち一通を公開し、その効果を解決します。",
      "他の人の手札は見せず、確認が終わったら封を閉じて渡します。",
      "山札が尽きるか一人だけ残ったら、最も強い密書の持ち主が勝利します。",
    ],
  },
  tutorial: {
    title: "チュートリアル",
